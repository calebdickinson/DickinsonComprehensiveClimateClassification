...
function classifyCold(tC) {
  return ee.Image.constant(0)
    .where(tC.gte(20).and(tC.lt(30)),   20) // A: Supertropical
    .where(tC.gte(10).and(tC.lt(20)),   19) // B: Tropical
    .where(tC.gte(5).and(tC.lt(10)),    18) // C2: Subtropical
    .where(tC.gte(0).and(tC.lt(5)),     17) // C1: Temperate
    .where(tC.gte(-5).and(tC.lt(0)),    16) // D2: Mild Continental
    .where(tC.gte(-10).and(tC.lt(-5)),  15) // D2: Moderate Continental
    .where(tC.gte(-15).and(tC.lt(-10)), 14) // E2: Severe Continental
    .where(tC.gte(-20).and(tC.lt(-15)), 13) // E1: Mild Subarctic
    .where(tC.gte(-30).and(tC.lt(-20)), 12) // F: Subarctic
    .where(tC.gte(-40).and(tC.lt(-30)), 11) // G: Arctic
    .where(tC.lt(-40),                  10) // Y: Superarctic
    .rename('coldZone');
}
...
var codeColorMap = {
  20: "#C71585", // A: Supertropical
  19: "#FF0000", // B: Tropical
  18: "#FFA500", // C2: Subtropical
  17: "#55AA00", // C1: Temperate
  16: "#008800", // D2: Mild Continental
  15: "#006600", // D1: Moderate Continental
  14: "#004400", // E2: Severe Continental
  13: "#008888", // E1: Mild Subarctic
  12: "#0000FF", // F: Subarctic
  11: "#FFC0CB", // G: Arctic
  10: "#000000"  // Y: Superarctic
};
