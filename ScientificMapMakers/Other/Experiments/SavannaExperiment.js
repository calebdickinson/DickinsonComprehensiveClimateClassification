...
var clim = aridBase
  ...
  // Monsoon: ≥80% precip in ANY 6 consecutive months with semihumid or humid aridity
  .where(
    P6ratio.gte(0.8)
      .and(aridBase.neq(1))
      .and(aridBase.neq(2))
  ...
  // Savanna (v): ≥80% precip in ANY 6 consecutive months
// with semiarid OR semihumid aridity
.where(
  P6ratio.gte(0.8)
    .and(
      aridBase.eq(2)
