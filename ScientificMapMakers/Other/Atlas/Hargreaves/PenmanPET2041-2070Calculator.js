...
var PET_penman_mean_future = PET_harg_mean_future
  ...
  .rename('CHELSA_pet_penman_mean_2041-2070')
  .max(0);
...
Map.addLayer(PET_harg_mean_future, {min:0, max:250, palette:['#f7fbff','#6baed6','#08306b']}, 'PET mean (Harg) 2041–2070', false);
Map.addLayer(PET_penman_mean_future, {min:0, max:250, palette:['#ffffe5','#7fcdbb','#2c7fb8']}, 'PET mean (Penman-equivalent) 2041–2070', true);
...
Export.image.toAsset({
  image: PET_penman_mean_future
    ...
    .clip(WORLD_RECT),
  description: 'Export_CHELSA_pet_penman_mean_2041-2070',
