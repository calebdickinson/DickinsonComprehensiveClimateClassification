// === Aridity Index Map (CHELSA TraCE21k, 20 ka BP) — Hargreaves PET ===
...
for (var m = 1; m <= 12; m++) {
  var mm = (m < 10 ? '0' + m : '' + m);
  var minId = PREFIX + 'CHELSA_TraCE21k_tasmin_' + mm + '_-200_V1-0';
  var maxId = PREFIX + 'CHELSA_TraCE21k_tasmax_' + mm + '_-200_V1-0';
