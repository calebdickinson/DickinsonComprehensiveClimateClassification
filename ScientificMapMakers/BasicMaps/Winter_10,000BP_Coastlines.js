...
for (var m = 1; m <= 12; m++) {
  ...
  var minId = ASSET_PREFIX + 'CHELSA_TraCE21k_tasmin_' + mm + '_-100_V1-0';
  var maxId = ASSET_PREFIX + 'CHELSA_TraCE21k_tasmax_' + mm + '_-100_V1-0';
...
coldZone = coldZone.updateMask(bedrockMask);

var discreteLand = coldZone.remap(codes, indices, -1).rename('classIndex');
