// === CHELSA UKESM ssp858 (2071–2100) — Dickinson rules & your uploaded assets ===
...
var cityList = [
  ...
  { name: 'Guangzhou, China',                                            lon: 113.2644,  lat: 23.1291 },
  ...
  { name: 'Seoul, South Korea',                                          lon: 126.9780,  lat: 37.5665 },
  ...
  { name: 'New York, New York, United States',                           lon: -74.0060,  lat: 40.7128 },
  ...
  { name: 'Los Angeles, California, United States',                      lon: -118.2437, lat: 34.0522 },
  { name: 'Johannesburg, South Africa',                                  lon: 28.0473,   lat: -26.2041 },
  ...
  { name: 'Osaka, Japan',                                                lon: 135.5023,  lat: 34.6937 },
  ...
  { name: 'Chicago, Illinois, United States',                            lon: -87.6298,  lat: 41.8781 },
  { name: 'Miami, Florida, United States',                               lon: -80.1918,  lat: 25.7617 },
  { name: 'Houston, Texas, United States',                               lon: -95.3698,  lat: 29.7604 },
  { name: 'Dallas, Texas, United States',                                lon: -96.7970,  lat: 32.7767 },
  { name: 'Philadelphia, Pennsylvania, United States',                   lon: -75.1652,  lat: 39.9526 },
  { name: 'Washington, District of Columbia, United States',             lon: -77.0369,  lat: 38.9072 },
  { name: 'Atlanta, Georgia, United States',                             lon: -84.3880,  lat: 33.7490 },
  { name: 'Boston, Massachusetts, United States',                        lon: -71.0589,  lat: 42.3601 },
  { name: 'Phoenix, Arizona, United States',                             lon: -112.0740, lat: 33.4484 },
  { name: 'Detroit, Michigan, United States',                            lon: -83.0458,  lat: 42.3314 },
  { name: 'Seattle, Washington, United States',                          lon: -122.3321, lat: 47.6062 },
  { name: 'San Francisco, California, United States',                    lon: -122.4194, lat: 37.7749 },
  { name: 'San Diego, California, United States',                        lon: -117.1611, lat: 32.7157 },
  { name: 'Minneapolis, Minnesota, United States',                       lon: -93.2650,  lat: 44.9778 },
  { name: 'Tampa, Florida, United States',                               lon: -82.4572,  lat: 27.9506 },
  { name: 'Denver, Colorado, United States',                             lon: -104.9903, lat: 39.7392 },
  { name: 'Riverside, California, United States',                        lon: -117.3962, lat: 33.9533 },
  { name: 'Baltimore, Maryland, United States',                          lon: -76.6122,  lat: 39.2904 },
  { name: 'Las Vegas, Nevada, United States',                            lon: -115.1398, lat: 36.1699 },
  { name: 'St. Louis, Missouri, United States',                          lon: -90.1994,  lat: 38.6270 },
  { name: 'Portland, Oregon, United States',                             lon: -122.6765, lat: 45.5231 },
  { name: 'San Antonio, Texas, United States',                           lon: -98.4936,  lat: 29.4241 },
  { name: 'Sacramento, California, United States',                       lon: -121.4944, lat: 38.5816 },
  { name: 'Orlando, Florida, United States',                             lon: -81.3792,  lat: 28.5383 },
  { name: 'San Juan, Puerto Rico, United States',                        lon: -66.1057,  lat: 18.4655 },
  { name: 'San Jose, California, United States',                         lon: -121.8863, lat: 37.3382 },
  { name: 'Austin, Texas, United States',                                lon: -97.7431,  lat: 30.2672 },
  { name: 'Pittsburgh, Pennsylvania, United States',                     lon: -79.9959,  lat: 40.4406 },
  { name: 'Cleveland, Ohio, United States',                              lon: -81.6944,  lat: 41.4993 },
  { name: 'Indianapolis, Indiana, United States',                        lon: -86.1581,  lat: 39.7684 },
  { name: 'Cincinnati, Ohio, United States',                             lon: -84.5120,  lat: 39.1031 },
  { name: 'Kansas City, Missouri, United States',                        lon: -94.5786,  lat: 39.0997 },
  { name: 'Columbus, Ohio, United States',                               lon: -82.9988,  lat: 39.9612 },
  { name: 'Virginia Beach, Virginia, United States',                     lon: -75.9779,  lat: 36.8529 },
  { name: 'Charlotte, North Carolina, United States',                    lon: -80.8431,  lat: 35.2271 },
  { name: 'Milwaukee, Wisconsin, United States',                         lon: -87.9065,  lat: 43.0389 },
  { name: 'Providence, Rhode Island, United States',                     lon: -71.4128,  lat: 41.8240 },
  { name: 'Jacksonville, Florida, United States',                        lon: -81.6557,  lat: 30.3322 },
  { name: 'Salt Lake City, Utah, United States',                         lon: -111.8910, lat: 40.7608 },
  { name: 'Nashville, Tennessee, United States',                         lon: -86.7816,  lat: 36.1627 },
  { name: 'Raleigh, North Carolina, United States',                      lon: -78.6382,  lat: 35.7796 },
  { name: 'Richmond, Virginia, United States',                           lon: -77.4360,  lat: 37.5407 },
  { name: 'Memphis, Tennessee, United States',                           lon: -90.0490,  lat: 35.1495 },
  { name: 'Oklahoma City, Oklahoma, United States',                      lon: -97.5164,  lat: 35.4676 },
  { name: 'Hartford, Connecticut, United States',                        lon: -72.6851,  lat: 41.7637 },
  { name: 'Louisville, Kentucky, United States',                         lon: -85.7585,  lat: 38.2527 },
  { name: 'New Orleans, Louisiana, United States',                       lon: -90.0715,  lat: 29.9511 },
  { name: 'Buffalo, New York, United States',                            lon: -78.8784,  lat: 42.8864 },
  { name: 'Montgomery, Alabama, United States',                          lon: -86.3000,  lat: 32.3668 },
  { name: 'Juneau, Alaska, United States',                               lon: -134.4197, lat: 58.3019 },
  { name: 'Little Rock, Arkansas, United States',                        lon: -92.2896,  lat: 34.7465 },
  { name: 'Dover, Delaware, United States',                              lon: -75.5244,  lat: 39.1582 },
  { name: 'Tallahassee, Florida, United States',                         lon: -84.2807,  lat: 30.4383 },
  { name: 'Honolulu, Hawaii, United States',                             lon: -157.8583, lat: 21.3069 },
  { name: 'Boise, Idaho, United States',                                 lon: -116.2023, lat: 43.6150 },
  { name: 'Springfield, Illinois, United States',                        lon: -89.6501,  lat: 39.7817 },
  { name: 'Des Moines, Iowa, United States',                             lon: -93.6091,  lat: 41.6005 },
  { name: 'Topeka, Kansas, United States',                               lon: -95.6890,  lat: 39.0483 },
  { name: 'Frankfort, Kentucky, United States',                          lon: -84.8733,  lat: 38.2009 },
  { name: 'Baton Rouge, Louisiana, United States',                       lon: -91.1871,  lat: 30.4515 },
  { name: 'Augusta, Maine, United States',                               lon: -69.7795,  lat: 44.3106 },
  { name: 'Annapolis, Maryland, United States',                          lon: -76.4910,  lat: 38.9784 },
  { name: 'Lansing, Michigan, United States',                            lon: -84.5555,  lat: 42.7325 },
  { name: 'Jackson, Mississippi, United States',                         lon: -90.2120,  lat: 32.2988 },
  { name: 'Jefferson City, Missouri, United States',                     lon: -92.1735,  lat: 38.5767 },
  { name: 'Helena, Montana, United States',                              lon: -112.0360, lat: 46.5884 },
  { name: 'Lincoln, Nebraska, United States',                            lon: -96.6852,  lat: 40.8136 },
  { name: 'Carson City, Nevada, United States',                          lon: -119.8164, lat: 39.1638 },
  { name: 'Concord, New Hampshire, United States',                       lon: -71.5376,  lat: 43.2081 },
  { name: 'Trenton, New Jersey, United States',                          lon: -74.7430,  lat: 40.2171 },
  { name: 'Santa Fe, New Mexico, United States',                         lon: -105.9378, lat: 35.6870 },
  { name: 'Albany, New York, United States',                             lon: -73.7562,  lat: 42.6526 },
  { name: 'Bismarck, North Dakota, United States',                       lon: -100.7837, lat: 46.8083 },
  { name: 'Salem, Oregon, United States',                                lon: -123.0351, lat: 44.9429 },
  { name: 'Harrisburg, Pennsylvania, United States',                     lon: -76.8867,  lat: 40.2732 },
  { name: 'Columbia, South Carolina, United States',                     lon: -81.0348,  lat: 34.0007 },
  { name: 'Pierre, South Dakota, United States',                         lon: -100.3464, lat: 44.3683 },
  { name: 'Montpelier, Vermont, United States',                          lon: -72.5754,  lat: 44.2601 },
  { name: 'Olympia, Washington, United States',                          lon: -122.8931, lat: 47.0379 },
  { name: 'Charleston, West Virginia, United States',                    lon: -81.6326,  lat: 38.3498 },
  { name: 'Madison, Wisconsin, United States',                           lon: -89.4012,  lat: 43.0731 },
  { name: 'Cheyenne, Wyoming, United States',                            lon: -104.8202, lat: 41.1400 },
  ...
  { name: 'Ottawa, Ontario, Canada',                                     lon: -75.6972,  lat: 45.4215 },
  ...
  { name: 'Tarawa, Kiribati',                                            lon: 173.155,   lat: 1.37 },
  ...
  { name: 'Majuro, Marshall Islands',                                    lon: 171.035,   lat: 7.15 },
  ...
  { name: 'Pago Pago, American Samoa, United States',                    lat: -14.2756,  lon: -170.7020 },
  { name: 'Hagåtña, Guam, United States',                                lat: 13.4750,   lon: 144.7500 },
  { name: 'Saipan, Northern Mariana Islands, United States',             lat: 15.1778,   lon: 145.7500 },
  { name: 'Charlotte Amalie, United States Virgin Islands, United States',lat: 18.3419,  lon: -64.9307 },
  { name: 'San Juan, Puerto Rico, United States',                        lat: 18.4655,   lon: -66.1057 },
  ...
  { name: 'Toronto, Ontario, Canada',                                    lon: -79.3832,  lat: 43.6532 },
  { name: 'Ottawa, Ontario, Canada',                                     lon: -75.6972,  lat: 45.4215 },
  { name: 'Mississauga, Ontario, Canada',                                lon: -79.6475,  lat: 43.5890 },
  { name: 'Brampton, Ontario, Canada',                                   lon: -79.7576,  lat: 43.7315 },
  { name: 'Hamilton, Ontario, Canada',                                   lon: -79.8711,  lat: 43.2557 },
  { name: 'Montreal, Quebec, Canada',                                    lon: -73.5673,  lat: 45.5017 },
  { name: 'Quebec City, Quebec, Canada',                                 lon: -71.2080,  lat: 46.8139 },
  { name: 'Laval, Quebec, Canada',                                       lon: -73.7454,  lat: 45.6066 },
  { name: 'Gatineau, Quebec, Canada',                                    lon: -75.6648,  lat: 45.4765 },
  { name: 'Longueuil, Quebec, Canada',                                   lon: -73.5180,  lat: 45.5312 },
  { name: 'Vancouver, British Columbia, Canada',                         lon: -123.1207, lat: 49.2827 },
  { name: 'Surrey, British Columbia, Canada',                            lon: -122.8490, lat: 49.1044 },
  { name: 'Burnaby, British Columbia, Canada',                           lon: -122.9805, lat: 49.2488 },
  { name: 'Richmond, British Columbia, Canada',                          lon: -123.1360, lat: 49.1666 },
  { name: 'Abbotsford, British Columbia, Canada',                        lon: -122.2817, lat: 49.0504 },
  { name: 'Calgary, Alberta, Canada',                                     lon: -114.0719, lat: 51.0447 },
  { name: 'Edmonton, Alberta, Canada',                                    lon: -113.4909, lat: 53.5444 },
  { name: 'Red Deer, Alberta, Canada',                                    lon: -113.8112, lat: 52.2681 },
  { name: 'Lethbridge, Alberta, Canada',                                  lon: -112.8411, lat: 49.6956 },
  { name: 'St. Albert, Alberta, Canada',                                  lon: -113.6346, lat: 53.6305 },
  { name: 'Winnipeg, Manitoba, Canada',                                   lon: -97.1384,  lat: 49.8951 },
  { name: 'Brandon, Manitoba, Canada',                                    lon: -99.9537,  lat: 49.8485 },
  { name: 'Steinbach, Manitoba, Canada',                                  lon: -96.6846,  lat: 49.5215 },
  { name: 'Thompson, Manitoba, Canada',                                   lon: -97.8558,  lat: 55.7430 },
  { name: 'Portage la Prairie, Manitoba, Canada',                         lon: -98.2915,  lat: 49.9728 },
  { name: 'Saskatoon, Saskatchewan, Canada',                              lon: -106.6702, lat: 52.1332 },
  { name: 'Regina, Saskatchewan, Canada',                                 lon: -104.6189, lat: 50.4452 },
  { name: 'Prince Albert, Saskatchewan, Canada',                          lon: -105.7531, lat: 53.2033 },
  { name: 'Moose Jaw, Saskatchewan, Canada',                              lon: -105.5516, lat: 50.3940 },
  { name: 'Swift Current, Saskatchewan, Canada',                          lon: -107.7972, lat: 50.2853 },
  { name: 'Halifax, Nova Scotia, Canada',                                 lon: -63.5752,  lat: 44.6488 },
  { name: 'Cape Breton Regional Municipality, Nova Scotia, Canada',       lon: -60.8964,  lat: 46.2468 },
  { name: 'Truro, Nova Scotia, Canada',                                   lon: -63.2625,  lat: 45.3648 },
  { name: 'New Glasgow, Nova Scotia, Canada',                             lon: -62.6450,  lat: 45.5866 },
  { name: 'Amherst, Nova Scotia, Canada',                                 lon: -64.2048,  lat: 45.8371 },
  { name: 'Moncton, New Brunswick, Canada',                               lon: -64.7782,  lat: 46.0878 },
  { name: 'Saint John, New Brunswick, Canada',                            lon: -66.0590,  lat: 45.2733 },
  { name: 'Fredericton, New Brunswick, Canada',                           lon: -66.6431,  lat: 45.9636 },
  { name: 'Dieppe, New Brunswick, Canada',                                lon: -64.7035,  lat: 46.0893 },
  { name: 'Miramichi, New Brunswick, Canada',                             lon: -65.5031,  lat: 47.0031 },
  { name: 'St. John\'s, Newfoundland and Labrador, Canada',               lon: -52.7126,  lat: 47.5615 },
  { name: 'Conception Bay South, Newfoundland and Labrador, Canada',      lon: -52.8667,  lat: 47.5333 },
  { name: 'Mount Pearl, Newfoundland and Labrador, Canada',               lon: -52.8190,  lat: 47.5218 },
  { name: 'Paradise, Newfoundland and Labrador, Canada',                  lon: -52.8285,  lat: 47.5080 },
  { name: 'Corner Brook, Newfoundland and Labrador, Canada',              lon: -57.9140,  lat: 48.9359 },
  { name: 'Charlottetown, Prince Edward Island, Canada',                  lon: -63.1307,  lat: 46.2382 },
  { name: 'Yellowknife, Northwest Territories, Canada',                   lon: -114.3718, lat: 62.4539 },
  { name: 'Hay River, Northwest Territories, Canada',                     lon: -115.7978, lat: 60.8394 },
  { name: 'Inuvik, Northwest Territories, Canada',                        lon: -133.7168, lat: 68.3601 },
  { name: 'Fort Smith, Northwest Territories, Canada',                    lon: -112.4181, lat: 60.0238 },
  { name: 'Behchoko, Northwest Territories, Canada',                      lon: -114.3813, lat: 62.8032 },
  { name: 'Fort Simpson, Northwest Territories, Canada',                  lon: -122.7271, lat: 61.7488 },
  { name: 'Fort Providence, Northwest Territories, Canada',               lon: -117.7656, lat: 61.3718 },
  { name: 'Tuktoyaktuk, Northwest Territories, Canada',                   lon: -133.0358, lat: 69.4447 },
  { name: 'Norman Wells, Northwest Territories, Canada',                  lon: -126.8043, lat: 65.2820 },
  { name: 'Fort Good Hope, Northwest Territories, Canada',                lon: -128.6504, lat: 66.2405 },
  { name: 'Iqaluit, Nunavut, Canada',                                     lon: -68.5150,  lat: 63.7467 },
  { name: 'Rankin Inlet, Nunavut, Canada',                                lon: -92.0966,  lat: 62.8192 },
  { name: 'Arviat, Nunavut, Canada',                                      lon: -94.0608,  lat: 61.1099 },
  { name: 'Cambridge Bay, Nunavut, Canada',                               lon: -105.0667, lat: 69.1167 },
  { name: 'Baker Lake, Nunavut, Canada',                                  lon: -96.0010,  lat: 64.2986 },
  { name: 'Pangnirtung, Nunavut, Canada',                                 lon: -65.7131,  lat: 66.1440 },
  { name: 'Pond Inlet, Nunavut, Canada',                                  lon: -70.7439,  lat: 72.6961 },
  { name: 'Igloolik, Nunavut, Canada',                                    lon: -81.7890,  lat: 69.3648 },
  { name: 'Coral Harbour, Nunavut, Canada',                               lon: -83.3680,  lat: 64.1380 },
  { name: 'Qikiqtarjuaq, Nunavut, Canada',                                lon: -64.0305,  lat: 67.5459 },
  { name: 'Anchorage, Alaska, United States',                             lon: -149.8936, lat: 61.21667 },
  { name: 'Fairbanks, Alaska, United States',                             lon: -147.7231, lat: 64.84361 },
  { name: 'Knik-Fairview, Alaska, United States',                         lon: -149.5981, lat: 61.52750 },
  { name: 'Badger, Alaska, United States',                                lon: -147.4103, lat: 64.80528 },
  { name: 'College, Alaska, United States',                               lon: -147.8272, lat: 64.84833 },
  { name: 'North Lakes, Alaska, United States',                           lon: -149.3019, lat: 61.60750 },
  { name: 'Meadow Lakes, Alaska, United States',                          lon: -149.6161, lat: 61.59972 },
  { name: 'Wasilla, Alaska, United States',                               lon: -149.4525, lat: 61.58167 },
  { name: 'Tanaina, Alaska, United States',                               lon: -149.4328, lat: 61.62417 },
  { name: 'Kalifornsky, Alaska, United States',                           lon: -151.2014, lat: 60.47333 },
  { name: 'Sitka, Alaska, United States',                                 lon: -135.3347, lat: 57.05333 },
  { name: 'Ketchikan, Alaska, United States',                             lon: -131.6480, lat: 55.34200 },
  { name: 'Kenai, Alaska, United States',                                 lon: -151.2297, lat: 60.55861 },
  { name: 'Steele Creek, Alaska, United States',                          lon: -147.5077, lat: 64.89241 },
  { name: 'Bethel, Alaska, United States',                                lon: -161.7558, lat: 60.79222 },
  { name: 'Chena Ridge, Alaska, United States',                           lon: -147.9283, lat: 64.83167 },
  { name: 'Sterling, Alaska, United States',                              lon: -150.7978, lat: 60.52972 },
  { name: 'Palmer, Alaska, United States',                                lon: -149.1172, lat: 61.60194 },
  { name: 'Gateway, Alaska, United States',                               lon: -149.2525, lat: 61.57639 },
  ...
  { name: 'Eureka Research Station, Nunavut, Canada',                     lon: -85.9500,  lat: 79.98300 },
  ...
  { name: 'Rexburg, Idaho, United States',                                 lon: -111.7839, lat: 43.82611 },
  { name: 'Carbondale, Illinois, United States',                           lon: -89.2203,  lat: 37.72640 },
  { name: 'Champaign, Illinois, United States',                            lon: -88.2436,  lat: 40.11639 },
  ...
  { name: 'Duluth, Minnesota, United States',                              lon: -92.10658, lat: 46.7832722 },
  { name: 'Lutsen, Minnesota, United States',                              lon: -90.67472, lat: 47.64722 },
  { name: 'Edinburgh of the Seven Seas',                                   lon: -12.3116,  lat: -37.0676 },
  { name: 'Adak, Alaska, United States',                                   lon: -176.636,  lat: 51.872 },
  ...
  { name: 'Thunder Bay, Ontario, Canada',                                  lon: -89.24611, lat: 48.382221 },
  { name: 'Isachsen Research Station, Nunavut, Canada',                    lon: -103.4932, lat: 78.776497 },
  { name: 'Tuktoyaktuk, Northwest Territories, Canada',                    lon: -133.0264, lat: 69.43333 },
  { name: 'Prudhoe Bay, Alaska, United States',                            lon: -148.4614, lat: 70.200523 },
  { name: 'Wainwright, Alaska, United States',                             lon: -160.0097, lat: 70.6417 },
  { name: 'Utqiagvik, Alaska, United States',                              lon: -156.7886, lat: 71.290558 },
  ...
  { name: 'Shoshoni, Wyoming, United States',                              lon: -108.1109, lat: 43.2355 },
  { name: 'Yakima, Washington, United States',                             lon: -120.5059, lat: 46.6021 },
  { name: 'Meeteetse, Wyoming, United States',                             lon: -108.8679, lat: 44.1569 },
  ...
  { name: 'Crystal City, Texas, United States',                            lon: -99.82778, lat: 28.68444 },
  { name: 'Barcelona, Spain',                                              lon: 2.1734,    lat: 41.3851 },
  { name: 'Sedona, Arizona, United States',                                lon: -111.7611, lat: 34.86972 },
  ...
  { name: 'Lompoc, California, United States',                             lon: -120.4603, lat: 34.64611 },
  ...
  { name: 'Grand Forks, North Dakota, United States',                      lon: -97.08834, lat: 47.9212639 },
  ...
  { name: 'Turpan, China',                                                lon: 89.1900,   lat: 42.9500 },
  { name: 'Lake Havasu City, Arizona, United States',                     lon: -114.3225, lat: 34.4839 },
  { name: 'Mawson Station, Antarctica',                                   lon: 62.8750,   lat: -67.6011 },
];
