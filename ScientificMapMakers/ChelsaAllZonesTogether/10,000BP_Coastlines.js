// === CHELSA African Humid Period 10,000 BP
...
for (var n = 1; n <= 12; n++) {
  var nn  = (n < 10 ? '0' + n : '' + n);
  var pid = ASSET_PREFIX + 'CHELSA_TraCE21k_pr_' + nn + '_-100_V1-0';
...
var bedrockMask = bedrock.gte(-50);   // true where bedrock is at or above -125 m
