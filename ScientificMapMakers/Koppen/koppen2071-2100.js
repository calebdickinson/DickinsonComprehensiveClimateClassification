// === CHELSA UKESM1 SSP5-8.5 (2071–2100) — Köppen Classification ===
...
for (var m = 1; m <= 12; m++) {
  ...
  var raw = ee.Image(ASSET_PREFIX +
    'CHELSA_ukesm1-0-ll_r1i1p1f1_w5e5_ssp585_tas_' + mm + '_2071_2100_norm');
  tasImgs.push(
...
for (var n = 1; n <= 12; n++) {
  ...
  var rawP = ee.Image(ASSET_PREFIX +
    'CHELSA_ukesm1-0-ll_r1i1p1f1_w5e5_ssp585_pr_' + nn + '_2071_2100_norm');
  prImgs.push(
...
Map.addLayer(
  ...
  'Köppen (UKESM1 SSP5-8.5, 2071–2100)',
  true,
  0.8
);
