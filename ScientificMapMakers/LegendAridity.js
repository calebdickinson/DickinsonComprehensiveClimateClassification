...
<body>
  <script>
    // ---------- CONFIG ----------
    const LEGEND_ITEMS = [
      { label: "Humid (H)",           color: "#008800" },
      { label: "Semihumid (G)",       color: "#00FF00" },
      { label: "Semiarid (S)",        color: "#FFAA00" },
      { label: "Arid Desert (D)",     color: "#FF0000" },
      { label: "Monsoon (W)",         color: "#FF00FF" },
      { label: "Mediterranean (M)",   color: "#FFFF00" },
