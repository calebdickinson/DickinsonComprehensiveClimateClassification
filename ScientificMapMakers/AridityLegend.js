...
style.textContent = `
  .legend {
    ...
    font: 28px/1.2 system-ui, Arial, sans-serif; color: #222;
    box-shadow: 0 8px 28px rgba(0,0,0,.08);
    transform: scale(1); /* optional for fine-tuning */
  }
  .legend-item { display: flex; align-items: center; gap: 20px; }
  .legend-swatch {
    width: 72px; height: 36px; border: 2px solid #333; border-radius: 6px;
    box-sizing: border-box;
  }
  /* Checkerboard for transparent (Ocean) */
