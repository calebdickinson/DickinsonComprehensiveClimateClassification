...
var clim = aridBase
  ...
  // keep your existing explicit ocean write
  .where(oceanMask, 8)

  // split the cold rule into ocean vs land using your proven aridBase=8 split
  .where(coldCond.and(aridBase.eq(8)),  7)  // cold over ocean → 7
  .where(coldCond.and(aridBase.neq(8)), 9)  // cold over land  → 9
...
var STATE_NAME = 'New Hampshire';  // <- change me
