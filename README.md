...
*These are generated by other programs*

`data/cities.csv` an intermediate database that lists cities and their climates at different time periods

`data/data.json` the final and real database and lists climates and their characteristics. 

### Backend

*Images and programs that handle the database*
...
*A website for viewing images and the database*

`index.html` the landing page, lets you search for climates by temperature
