...
assigned to the same category if they occupy the same region of climate space as defined in this taxonomy. This design choice preserves classification
...
coldest-month mean temperature ($T_{\min,\text{mean}}$), which provides a measure of winter thermal constraint that is insensitive to short-
...
($T_{\max,\text{mean}}$). This metric provides a measure of summer
