...
def generate_json() -> dict[str, dict]: #type:ignore
    ...
    for code in climates.codes:
        database[code] = {
            ...
            'go_to_hotter_summer': climates.traverse_codes(code, 'warm', -1),
            'go_to_colder_summer': climates.traverse_codes(code, 'warm', 1),
            'go_to_hotter_winter': climates.traverse_codes(code, 'cold', -1),
            'go_to_colder_winter': climates.traverse_codes(code, 'cold', 1),
