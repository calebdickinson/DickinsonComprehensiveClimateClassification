...
output of dickinson_winter_1981_2010 -> Polygonize. No separate
Reclassify step needed -- the zone -> pattern mapping is applied here
directly via rule filter expressions.
...
PATTERN_COLOR = QColor(0, 0, 0, 100)
